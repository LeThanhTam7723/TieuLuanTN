...
const ProductListBrandPage = () => {
  ...
  useEffect(() => {
    loadProducts();
  }, [brandSlug, selectedColors, selectedSizes, priceRange, sortBy, currentPage]);
  ...
  const loadProducts = async () => {
    ...
    try {
      ...
      const data = await ProductService.getProductByBrandSlug(brandSlug, filters);
...
export default ProductListBrandPage;